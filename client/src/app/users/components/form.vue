<template>
  <div class="column is-8">
    <div class="content">
      ...
      <div class="field">
        <p class="control">
          <input class="input is-medium" type="text" name="username" placeholder="Usuário" v-model="name">
        </p>
      </div>
      <h3>Email:</h3>
      <div class="field">
      ...
      <hr>
      <button v-bind:class="{ 'is-disabled' : !(this.name !== '' && this.email !== '' && this.password !== '') }" type="button"  class="button is-primary" @click="submit">Registrar</button>
