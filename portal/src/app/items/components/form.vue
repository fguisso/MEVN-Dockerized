    ...
    <div class="content">
      ...
      <div class="field">
        <p class="control">
          <input
            ...
            name="itemName" placeholder="Caramelo" v-model="name">
        </p>
      </div>
      <h3>Solicitante:</h3>
      <div class="field">
        <p class="control">
          <input
          aria-label="test" class="input is-medium" type="text"
      ...
      <div class="field">
        <p class="control">
          ...
          type="text" name="status" placeholder="Pending" v-model="status">
        </p>
      </div>
      <hr>
      <button v-bind:class="{
