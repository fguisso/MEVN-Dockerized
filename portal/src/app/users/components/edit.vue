<template>
  <div class="column is-8">
    <div class="content">
      ...
      <div class="field">
        <p class="control">
          <input aria-label="test" class="input is-medium"
            type="text" name="itemName" placeholder="Arroz" v-model="name">
        </p>
      </div>
      ...
      <div class="field">
        <p class="control">
          <input aria-label="test" class="input is-medium" type="text"
            name="accessLevel" placeholder="Admin" v-model="accessLevel">
        </p>
      </div>
      <h3>Email:</h3>
      <div class="field">
      ...
      <div class="field">
        <p class="control">
          ...
          name="password" placeholder="Entregue" v-model="password">
        </p>
      </div>
      <hr>
      <button v-bind:class="{
        'is-disabled' : this.name === '' && this.accessLevel === '' &&
        this.email === '' && this.password === ''
        }" type="button"  class="button is-primary" @click="edit">Editar</button>
